...
import { Edit, Eye, FilterIcon, MoreHorizontal, PlusIcon, SearchIcon, Trash2, Wallet, X } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
    ...
    <main className="px-4 sm:px-6 lg:px-8 py-8 w-full">
      ...
      >
        ...
        <DialogContent className="p-0">
          <DialogHeader className="bg-primary p-4 rounded-t-lg flex  justify-between">
